...
class BookingPanel extends JPanel {
    ...
    private void showPaymentOptions(int id, User frame) {
        ...
        JDialog paymentDialog = new JDialog((JFrame) SwingUtilities.getWindowAncestor(this), "Deposit Options", true);
        ...
        paymentDialog.add(new PaymentOptionsPanel(id, frame, false));
	...
	private ArrayList<Parkinglot>  loadCSVData() throws CsvValidationException {
	    ...
	    try (CSVReader reader = new CSVReader(new FileReader(filePath.toFile()))) {
	        ...
	        while ((nextLine = reader.readNext()) != null) {
	            ...
	            lots.add(new Parkinglot(Integer.parseInt(nextLine[0]), nextLine[1], nextLine[2], (nextLine[3].equals("Y") ? true : false), 100));
				for(int i = 4; i < 104; i++) {
	...
	private void extendBooking(int id, int hours, User frame) throws CsvValidationException {
	    ...
	    for(int i = 1; i < bookings.size(); i++) {
	    	if(id == Integer.parseInt(bookings.get(i)[0])) {
	    		...
	    		double newCost = Double.parseDouble(bookings.get(i)[3])*hours + Double.parseDouble(bookings.get(i)[9]);
...
class PaymentPanel extends JPanel {
    ...
    public PaymentPanel(User frame) {
        ...
        // Text field to display selected booking
        DueField = new JTextField("Amount to be Paid: ");
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow != -1) {
                    id = Integer.parseInt(tableModel.getValueAt(selectedRow, 0).toString());
                    DueField.setText("Amount to be Paid: " + String.valueOf( bookings.get(id-1).getCost() - frame.client.getParkingRate()));
                }
            }
        });
        ...
        // Panel for text field and button
        JPanel controlPanel = new JPanel();
        controlPanel.setLayout(new GridLayout(2, 1, 5, 5));
        controlPanel.add(DueField);
    ...
    private void showPaymentOptions(int id, User frame) {
        ...
        // Add the PaymentOptionsPanel to the dialog
        paymentDialog.add(new PaymentOptionsPanel(id, frame, true));
        paymentDialog.setVisible(true); // Make the dialog visible
    }
...
class PaymentOptionsPanel extends JPanel {
    public PaymentOptionsPanel(int id, User frame, boolean checkOut) {
     ...
     // Action listener for Credit Card payment
        creditCardButton.addActionListener(e -> {
            ...
            if (cardNumber != null && !cardNumber.isEmpty()) {
            	...
            	if(checkOut)
            		...
            		JOptionPane.showMessageDialog(this, "Deposit successful with Credit Card!");
            } else {
        ...
        paypalButton.addActionListener(e -> {
            ...
            if (email != null && !email.isEmpty()) {
                ...
                if(checkOut)
            		JOptionPane.showMessageDialog(this, "Payment successful with PayPal!");
            	else
            		JOptionPane.showMessageDialog(this, "Deposit successful with PayPal!");
            } else {
        ...
        cashButton.addActionListener(e -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if(checkOut)
            		JOptionPane.showMessageDialog(this, "Payment successful with Cash!");
            	else
            		JOptionPane.showMessageDialog(this, "Deposit successful with Cash!");
            } else {
